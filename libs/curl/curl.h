/*
 * @Author: seelights
 * @Date: 2025-09-21 19:17:53
 * @LastEditTime: 2025-09-21 21:23:40
 * @LastEditors: seelights
 * @Description: 
 * @FilePath: \ReportMason\libs\curl\curl.h
 * Copyright (c) 2025 by seelights@git.cn, All Rights Reserved.
 */
#ifndef CURLINC_CURL_H
#define CURLINC_CURL_H

// Define curl_off_t if not already defined
#ifndef curl_off_t
typedef long long curl_off_t;
#endif

// Basic curl function declarations
typedef void CURL;
typedef void CURLSH;
...
#define CURLOPT_PROGRESSDATA CURLOPT_XFERINFODATA
  ...
  */
  ...
  /* CURLINFO constants for curl_easy_getinfo */
  // Removed duplicate CURLINFO definitions to avoid conflicts
...
// Comment out these includes to avoid conflicts with system curl headers
