 ...
 * @Description: DOCX内容提取测试窗口
 * @FilePath: \ReportMason\src\DocxContentTestWidget.h
 * Copyright (c) 2025 by seelights@git.cn, All Rights Reserved.
 */

#ifndef DOCXCONTENTTESTWIDGET_H
#define DOCXCONTENTTESTWIDGET_H
 ...
 * 专门用于测试DOCX文件的内容提取功能
 */
class DocxContentTestWidget : public QWidget
{
    Q_OBJECT

public:
    explicit DocxContentTestWidget(QWidget* parent = nullptr);
    ~DocxContentTestWidget();
...
private:
    ...
    // 提取器实例
    DocxImageExtractor* m_imageExtractor;
    DocxTableExtractor* m_tableExtractor;
    DocxChartExtractor* m_chartExtractor;
